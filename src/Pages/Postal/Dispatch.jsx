...
import Add_DispatchModal from '../../Components/Modals/Add_DispatchModal';
    ...
    <Layout>
        ...
        <div className="header py-2 px-3 flex justify-between border-b">
          ...
          <button
                  ...
                  onClick={openModal}
                >
                  <FaPlus className='inline-block'/>Add Dispatch
                </button>
          {isModalOpen && <Add_DispatchModal closeModal={closeModal} />}
          </div>
